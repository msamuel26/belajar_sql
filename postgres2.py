...
print("masukkan banyak data ke dalam tabel database customer dalam 1 line code")
session.bulk_save_objects([new_customer, new_customer1, new_customer2,
             new_customer3, new_customer4], return_defaults=True)
session.commit()

# 2022-12-21 10:40:49,962 INFO sqlalchemy.engine.Engine BEGIN (implicit)
# 2022-12-21 10:40:49,962 INFO sqlalchemy.engine.Engine INSERT INTO customer (id, first_name, last_name, age, country) VALUES (nextval('customer_id_seq'), %(first_name)s, %(last_name)s, %(age)s, %(country)s) RETURNING customer.id
# 2022-12-21 10:40:49,962 INFO sqlalchemy.engine.Engine [generated in 0.00087s] ({'first_name': 'John', 'last_name': 'Doe', 'age': 31, 'country': 'USA'}, {'first_name': 'Robert', 'last_name': 
...
# 2022-12-21 10:40:49,969 INFO sqlalchemy.engine.Engine COMMIT
...
# 2022-12-21 10:45:33,308 INFO sqlalchemy.engine.Engine BEGIN (implicit)
# 2022-12-21 10:45:33,308 INFO sqlalchemy.engine.Engine INSERT INTO "order" (id, item, amount, customer_id) VALUES (nextval('order_id_seq'), %(item)s, %(amount)s, %(customer_id)s)
# 2022-12-21 10:45:33,308 INFO sqlalchemy.engine.Engine [generated in 0.00072s] ({'item': 'Keyboard', 'amount': 400, 'customer_id': 59}, {'item': 'Mouse', 'amount': 300, 'customer_id': 59}, {'item': 'Monitor', 'amount': 12000, 'customer_id': 58}, {'item': 'Keyboard', 'amount': 400, 'customer_id': 56})
# 2022-12-21 10:45:33,316 INFO sqlalchemy.engine.Engine COMMIT

print("engine execute")
engine.execute("insert into customer (id, first_name, last_name, age, country) values (6, 'Setip', 'Cengiri', 7, 'IDN')")

# 2022-12-21 10:45:33,316 INFO sqlalchemy.engine.Engine insert into customer (id, first_name, last_name, age, country) values (6, 'Setip', 'Cengiri', 7, 'IDN')
# 2022-12-21 10:45:33,316 INFO sqlalchemy.engine.Engine [raw sql] {}
# 2022-12-21 10:45:33,316 INFO sqlalchemy.engine.Engine COMMIT
